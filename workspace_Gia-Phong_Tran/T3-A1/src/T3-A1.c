...
//	//STEP2: STEPCONFIG
//	HWREG(SOC_ADC_TSC_0_REGS + TSC_ADC_SS_STEPCONFIG(1)) |= (1<<0); //STEP 1: "SW enabled, continuous"
//
//	HWREG(SOC_ADC_TSC_0_REGS + TSC_ADC_SS_STEPCONFIG(1)) |= (1<<4); //STEP 1: "16 samples average"
//
...
//	HWREG(SOC_ADC_TSC_0_REGS + TSC_ADC_SS_STEPCONFIG(1)) |= (1<<19); //STEP 1: AIN1 -> Channel 2 -> Setzen einer 1
//
//	HWREG(SOC_ADC_TSC_0_REGS + TSC_ADC_SS_STEPCONFIG(1)) &=~ (1<<26); //STEP 1: Store Data in FIFO -> Bit 26 löschen
