...
//	//STEP2: STEPCONFIG
	...
	while (1)
	{
		...
		meinADCWert2 = HWREG(SOC_ADC_TSC_0_REGS + TSC_ADC_SS_FIFODATA(0)); //invertiert (siehe Skizze)
		aux = (4100-meinADCWert2);
		meinADCWert2 = aux; //invertieren

		motorAnsteuernMitLenkung(meinADCWert, meinADCWert2);

		//delay_ms(500); //uncomment for debugging purposes
